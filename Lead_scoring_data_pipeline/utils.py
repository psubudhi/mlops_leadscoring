...
from Lead_scoring_data_pipeline.mapping.city_tier import city_tier_mapping
...
def load_data_into_db():
    ...
    try:
        ...
        #    return
        print("Load CSV file: " + CSV_FILE_PATH+CSV_FILE_NAME)
        df = read_csv_file(CSV_FILE_PATH+CSV_FILE_NAME)
